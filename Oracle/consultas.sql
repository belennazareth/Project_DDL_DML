...
--Funciones
--1 Elabora una función que reciba el estado y devuelva la cantidad de artículos que existen en ese estado.
    ...
    DECLARE 
        V_CANTIDAD NUMBER;
    BEGIN
        V_CANTIDAD := COUNT_ARTICULOS_ESTADO('Nuevo');
        DBMS_OUTPUT.PUT_LINE('Hay '||V_CANTIDAD||' artículos nuevos');
    END;
    /